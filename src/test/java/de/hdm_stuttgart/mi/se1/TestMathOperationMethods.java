...
public class TestMathOperationMethods {
    ...
    /**
     * preparing testString for sort method
     * calling sort method to execute calculations
     *
     * @param testString Input String which needs to be calculated
     * @return returns result of calculation (peek of calculationNumbersStack)
     */
